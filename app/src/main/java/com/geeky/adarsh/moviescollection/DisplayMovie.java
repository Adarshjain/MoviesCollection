...
import com.geeky.adarsh.moviescollection.Fragments.CastInfoFragment;
...
////    private SimpleDateFormat df = new SimpleDateFormat("yyyy");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_display_movie);
...
//        String id = b.getString("id");
        ...
        Fragment mainFragment = DisplayMovieFragment.newInstance("", "");
        b.putInt("tagger",1);
        mainFragment.setArguments(b);
        ft.add(R.id.dummy_main_2, mainFragment);
        ft.commit();
...
//        });
    ...
    public void changeFrag(Bundle b,int i){
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction ft = manager.beginTransaction();
        Fragment mainFragment = DisplayMovieFragment.newInstance("", "");
        b.putInt("tagger",i+1);
        mainFragment.setArguments(b);
        ft.replace(R.id.dummy_main_2, mainFragment,"Tag" + i);
        ft.addToBackStack("Tag" + i);
        ft.commit();
    }

    public void changeSimMov(Bundle b, int tagger){
...
//                                @Override
//                                public void onClick(View view) {
//                                    Intent intent = new Intent(DisplayMovie.this, DisplayMovieSimilar.class);
//                                    Bundle b = new Bundle();
